$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Ravi and Simi's Wedding",

            // Event start date
            start: new Date('Sept 11, 2027 10:00'),
            ...
            end: new Date('Sept 11, 2027 00:00'),

            // Event Address
            address: 'TBC',

            // Event Description
            description: "We can't wait to see you on our big day. For any queries or issues, please contact ... at ..."
        }
    });
...
// Google map
function initMap() {
    var location = {lat: 51.5014, lng: 0.1419};
